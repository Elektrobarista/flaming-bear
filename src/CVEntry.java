...
public class CVEntry extends CVProperty {
	...
	/**
	 * Constructor
	 * Sets the values representing this cvEntry.
	 * @param values - the values to set
	 * @throws IllegalArgumentException if values.length != 6 or values == null or [(values[0] or values[1])
	 * is (null or "")]
	 */
	...
	public void setValues(String[] values) throws IllegalArgumentException{
		if (values == null || values.length != 6 || values[0] == null || values[0].equals("") +
				values[1] == null || values[1].equals(""))
