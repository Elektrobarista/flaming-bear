...
public class Section {
	 ...
	 * @throws IllegalArgumentException if and only if name==null or name is ""
	 */
	 ...
	 * @throws NullPointerException if and only if prop==null
	 */
	...
	/**
	 * Inserts prop at the specified position in this list. Shifts the element currently at 
	 * that position (if any) and any subsequent elements to the right (adds one to their indices).
	 * @param prop - the property to add
	 * @param index - the index, where to add prop
	 * @throws NullPointerException if and only if prop==null
	 * @throws IndexOutOfBoundsException if the index is out of range (index < 0 || index > length)
	 */
	public void addEntryAt(CVProperty prop, int index) throws NullPointerException, IndexOutOfBoundsException {
		if (prop==null)
			throw new NullPointerException();
	...
	/**
	 * Returns the String-representation of this section; written to compile with Latex.
